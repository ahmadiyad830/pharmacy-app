...
public class Medicines  implements Serializable {
    ...
    public Medicines(String id, String barcode, String name, String scientific, String concentration, String dosageform, String notes, String store, String sachet, String location, String quantity) {
        this.id = id;
    ...
    public Medicines(String id, String name, String scientific, String concentration, String dosageform, String notes, String store, String sachet, String location, String quantity) {
        this.id = id;
        this.name = name;
        this.scientific = scientific;
        this.concentration = concentration;
